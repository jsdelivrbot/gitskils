...
<script>
  ...
  export default {
    ...
    mounted: function() {
      if (window.sessionStorage.getItem("ZiXunXiaoXiStatisticalAnalysis") == null || window.sessionStorage.getItem("ZiXunXiaoXiStatisticalAnalysis") == false) {
        modelStatisticalAnalysis("029", "资讯信息", "ZiXunXiaoXiStatisticalAnalysis");
      }
      let self = this;
      this.getdata(function(lt){
        if(lt.length < self.PageSize) {
