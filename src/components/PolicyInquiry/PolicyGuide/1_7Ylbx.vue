<template>
  ...
  <div>
    ...
    <div class="search" v-if="!noresult">
    ...
    <div class="Ylbxlist-main" :style="pageh" v-if="!noresult">
      <mt-loadmore :auto-fill="false" :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore" :top-distance='10' bottom-pull-text="上拉加载更多" bottom-drop-text="释放加载" :style="pagesh">
        ...
        <div style="height: 32px;line-height: 32px;" v-if='ylbxList.length>10 && allLoaded'>已加载到底部</div>
      </mt-loadmore>
    </div>
...
<script>
  ...
  import { httpGetMethod,modul,State } from "../../../utils/api.js";
