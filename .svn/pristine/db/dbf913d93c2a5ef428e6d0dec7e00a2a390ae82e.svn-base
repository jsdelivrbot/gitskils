...
<script>
  ...
  import { modelStatisticalAnalysis } from "../../../utils/base.js"; //模块统计分析
	export default {
		...
		mounted(){
      if (window.sessionStorage.getItem("ZhuanJiaDaFuStatisticalAnalysis") == null || window.sessionStorage.getItem("ZhuanJiaDaFuStatisticalAnalysis") == false) {
        //专家答复模块统计接口
        modelStatisticalAnalysis("041", "专家答复", "ZhuanJiaDaFuStatisticalAnalysis");
      }
      //列表初始化
      let self = this;
